    ...
    <nav class="bg-white">
        ...
        >
            <a href="/" class="flex items-center">
                <img src="./aric-logo-removebg-preview.png" class="h-8 mr-3" alt=" Logo" />
                <span
    ...
    <section cclass="bg-grey-50" id="about">
        ...
        >
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                >
                    <div class="flex items-center justify-center sm:justify-start font-body text-lg font-semibold uppercase text-grey-20">
                        Connect With Me
                    </div>
                    <div
                    ...
                    >
                        <a
                            href="https://www.instagram.com/ariicgg/" target="_blank"
                            
                        >
                            <img src="./ig.png" class="h-8 mr-3" alt=" Logo" />
                        </a>
            ...
            >
                <div className="sm:col-span-12 lg:col-span-3">
                    ...
                    <div className="text-sm text-gray-600">
                        <img
                            src="./aric-logo-removebg-preview.png"
                            class="h-8 mr-3"
                            alt=" Logo"
                        />
                        <span
